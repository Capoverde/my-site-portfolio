...
const buttonData = [
  ...
  { id:14, text: 'Node.js', href: '/AboutPage', icon: <FaNodeJs color={iconColor} />},
  { id:15, text: 'Redux', href: '/AboutPage', icon: <SiRedux color={iconColor} /> },
  { id:16, text: 'HTML', href: '/AboutPage', icon: <AiOutlineHtml5 color={iconColor} /> },
  { id:17, text: 'Vue.js', href: '/AboutPage', icon: <RiVuejsLine color={iconColor} /> },
  { id:18, text: 'Jest', href: '/AboutPage', icon: <SiJest color={iconColor} />},
  { id:19, text: 'Cypress', href: '/AboutPage', icon: <TbBrandCypress color={iconColor} /> },
  { id:20, text: 'Linux', href: '/AboutPage', icon: <FaLinux color={iconColor}  />},
  { id:21, text: 'REST API', href: '/AboutPage', icon: <TbApi color={iconColor} /> },
  { id:22, text: 'jQuery', href: '/AboutPage', icon: <BiLogoJquery color={iconColor} /> },
  { id:23, text: 'AdobeXD', href: '/AboutPage', icon: <TbBrandAdobe color={iconColor} /> },
  { id:24, text: 'Bootstrap', href: '/AboutPage', icon: <RiBootstrapLine color={iconColor} /> },
  { id:25, text: 'TypeScript', href: '/AboutPage', icon: <TbBrandTypescript color={iconColor} /> },
